...
class SetOwnerTest(LucteriosTest):
    ...
    def test_config(self):
        ...
        self.assert_count_equal('', 2 + 16 + 2 + 2)
        ...
        self.assert_json_equal('LABELFORM', 'condominium-payoff-calloffunds', 'Non')
    ...
    def test_add_set(self):
        ...
        self.assert_json_equal('SELECT', "type_load", 0)
        self.assert_json_equal('CHECK', "is_link_to_lots", 1)
        self.assert_json_equal('SELECT', "secondarykey", 0)
        self.assert_json_equal('CHECKLIST', "set_of_lots", [])

        self.factory.xfer = SetAddModify()
        self.calljson('/diacamma.condominium/setAddModify', {'SAVE': 'YES', "name": "abc123", 'type_load': 1, "is_link_to_lots": 0}, False)
        ...
        self.factory.xfer = SetAddModify()
        self.calljson('/diacamma.condominium/setAddModify', {'SAVE': 'YES', "name": "xyz987", 'type_load': 0, "is_link_to_lots": 0}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'setAddModify')
...
"""
    ...
    def test_modify_partition(self):
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_count_equal('', 10)
        self.assert_grid_equal('partitionfill', {"owner": "propriétaire", "value": "tantième", "ratio": "ratio", "ventilated": "ventilé"}, 3)  # nb=4
        self.assert_json_equal('', 'partitionfill/@0/value', '0.00')
        self.assert_json_equal('', 'partitionfill/@0/owner', 'Minimum')
        self.assert_json_equal('', 'partitionfill/@1/value', '0.00')
        self.assert_json_equal('', 'partitionfill/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partitionfill/@2/value', '0.00')
        self.assert_json_equal('', 'partitionfill/@2/owner', 'Dalton Joe')
        self.assert_count_equal('#partitionfill/actions', 2)
        ...
        self.calljson('/diacamma.condominium/partitionAddModify', {'partitionfill': 1}, False)
        self.assert_observer('core.custom', 'diacamma.condominium', 'partitionAddModify')
        self.assert_count_equal('', 4)

        self.factory.xfer = PartitionAddModify()
        self.calljson('/diacamma.condominium/partitionAddModify', {'partitionfill': 1, 'SAVE': 'YES', 'value': 10}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'partitionAddModify')
        self.factory.xfer = PartitionAddModify()
        self.calljson('/diacamma.condominium/partitionAddModify', {'partitionfill': 2, 'SAVE': 'YES', 'value': 20}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'partitionAddModify')
        self.factory.xfer = PartitionAddModify()
        self.calljson('/diacamma.condominium/partitionAddModify', {'partitionfill': 3, 'SAVE': 'YES', 'value': 30}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'partitionAddModify')

        self.factory.xfer = SetShow()
        self.calljson('/diacamma.condominium/setShow', {'set': 1}, False)
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_count_equal('partitionfill', 3)
        self.assert_json_equal('', 'partitionfill/@0/value', '10.00')
        self.assert_json_equal('', 'partitionfill/@0/ratio', 16.67)
        self.assert_json_equal('', 'partitionfill/@1/value', '20.00')
        self.assert_json_equal('', 'partitionfill/@1/ratio', 33.33)
        self.assert_json_equal('', 'partitionfill/@2/value', '30.00')
        self.assert_json_equal('', 'partitionfill/@2/ratio', 50.0)
...
"""
        ...
        self.calljson('/diacamma.condominium/setShow', {'set': 1}, False)
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_json_equal('', 'partitionfill/@0/value', '120.00')
        self.assert_json_equal('', 'partitionfill/@0/owner', 'Minimum')
        self.assert_json_equal('', 'partitionfill/@1/value', '0.00')
        self.assert_json_equal('', 'partitionfill/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partitionfill/@2/value', '80.00')
        self.assert_json_equal('', 'partitionfill/@2/owner', 'Dalton Joe')
    ...
    def test_merge_contacts(self):
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_count_equal('partitionfill', 3)
        self.assert_json_equal('', 'partitionfill/@0/value', '45.00')
        self.assert_json_equal('', 'partitionfill/@0/owner', 'Minimum')
        self.assert_json_equal('', 'partitionfill/@1/value', '35.00')
        self.assert_json_equal('', 'partitionfill/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partitionfill/@2/value', '20.00')
        self.assert_json_equal('', 'partitionfill/@2/owner', 'Dalton Joe')
        ...
        self.assert_count_equal('third', 6)
        ...
        self.calljson('/diacamma.condominium/setShow', {'set': 1}, False)
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_count_equal('partitionfill', 2)
        partitions_value = [(partition['value'], partition['owner']) for partition in self.get_json_path('partitionfill')]
...
class ReportTest(PaymentTest):
    ...
    def test_financial(self):
        ...
        self.assert_json_equal('', 'report_1/@8/left_n', 72.80)
        ...
        self.assert_json_equal('', 'report_1/@10/left_n', 39.27)
        self.assert_json_equal('', 'report_1/@11/left', '[4502 Dalton William]')
        self.assert_json_equal('', 'report_1/@11/left_n', 33.95)
        ...
        self.assert_json_equal('', 'report_1/@8/right', '[4503 Dalton William]')
        self.assert_json_equal('', 'report_1/@8/right_n', 0.84)
        self.assert_json_equal('', 'report_1/@9/right', '[4504 Dalton William]')
        self.assert_json_equal('', 'report_1/@9/right_n', 0.35)
        self.assert_json_equal('', 'report_1/@10/right', '[4505 Dalton William]')
        self.assert_json_equal('', 'report_1/@10/right_n', 0.56)
...
class OwnerTest(PaymentTest):
    ...
    def test_owner_list(self):
        ...
        self.assert_count_equal('owner', 3)
        self.assert_json_equal('', 'owner/@0/third', 'Dalton Joe')
        self.assert_json_equal('', 'owner/@0/thirdinitial', 0)
        self.assert_json_equal('', 'owner/@0/thirdtotal', -76.25)
        self.assert_json_equal('', 'owner/@1/third', 'Dalton William')
        self.assert_json_equal('', 'owner/@1/thirdinitial', -12.5)
        self.assert_json_equal('', 'owner/@1/thirdtotal', -135.0)
        self.assert_json_equal('', 'owner/@2/third', 'Minimum')
        self.assert_json_equal('', 'owner/@2/thirdinitial', 29.18)
        self.assert_json_equal('', 'owner/@2/thirdtotal', -17.07)
        self.assert_count_equal('propertylot', 3)
        self.assert_json_equal('', 'propertylot/@0/owner', 'Minimum')
        self.assert_json_equal('', 'propertylot/@0/value_ratio', "45 (45.0 %)")
        self.assert_json_equal('', 'propertylot/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'propertylot/@1/value_ratio', "35 (35.0 %)")
        self.assert_json_equal('', 'propertylot/@2/owner', 'Dalton Joe')
        self.assert_json_equal('', 'propertylot/@2/value_ratio', "20 (20.0 %)")
    ...
    def test_payment_paypal_callfund(self):
        default_paymentmethod()
        add_test_callfunds()
        self.check_payment_paypal(5, "appel de fonds pour Minimum")
    ...
    def test_send_owner(self):
        ...
        try:
            ...
            msg_txt, msg, msg_file = server.check_first_message('my owner', 3, {'To': 'Minimum@worldcompany.com'})
    ...
    def test_owner_situation(self):
        ...
        self.assert_grid_equal('payments', {'date': 'date', 'assignment': 'affectation', 'amount': 'montant', 'mode': 'mode', 'bank_account': 'compte bancaire', 'reference': 'référence'}, 2)
        self.assert_json_equal('', 'payments/@0/date', "2015-06-15")
        self.assert_json_equal('', 'payments/@0/assignment', "appel de fonds N°1 Minimum")
        self.assert_json_equal('', 'payments/@0/amount', 100.0)
        self.assert_json_equal('', 'payments/@0/mode', 0)
        self.assert_json_equal('', 'payments/@1/date', "2015-07-21")
        self.assert_json_equal('', 'payments/@1/assignment', "appel de fonds N°2 Minimum")
        self.assert_json_equal('', 'payments/@1/amount', 30.0)
        self.assert_json_equal('', 'payments/@1/mode', 0)
    ...
    def test_set_ventilation(self):
        ...
        self.assert_json_equal('', 'partitionfill/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partitionfill/@1/ratio', 35.0)
        self.assert_json_equal('', 'partitionfill/@1/ventilated', 0.0)
        self.assert_json_equal('', 'partitionfill/@2/owner', 'Dalton Joe')
        self.assert_json_equal('', 'partitionfill/@2/ratio', 20.0)
        self.assert_json_equal('', 'partitionfill/@2/ventilated', 0.0)

        self.factory.xfer = SetShow()
        self.calljson('/diacamma.condominium/setShow', {"set": 2}, False)
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_count_equal('', 10)
        self.assert_json_equal('LABELFORM', 'sumexpense', 100.0)
        self.assert_json_equal('LABELFORM', 'is_link_to_lots', False)
        self.assert_count_equal('partitionfill', 3)
        self.assert_json_equal('', 'partitionfill/@0/owner', 'Minimum')
        self.assert_json_equal('', 'partitionfill/@0/ratio', 75.0)
        self.assert_json_equal('', 'partitionfill/@0/ventilated', 75.0)
        self.assert_json_equal('', 'partitionfill/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partitionfill/@1/ratio', 0.0)
        self.assert_json_equal('', 'partitionfill/@1/ventilated', 0.0)
        self.assert_json_equal('', 'partitionfill/@2/owner', 'Dalton Joe')
        self.assert_json_equal('', 'partitionfill/@2/ratio', 25.0)
        self.assert_json_equal('', 'partitionfill/@2/ventilated', 25.0)

        self.factory.xfer = SetShow()
        self.calljson('/diacamma.condominium/setShow', {"set": 3}, False)
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_count_equal('', 11)
        self.assert_json_equal('LABELFORM', 'sumexpense', 75.0)
        self.assert_json_equal('LABELFORM', 'is_link_to_lots', True)
        self.assert_json_equal('LABELFORM', 'secondarykey', 'sub')
        self.assert_count_equal('partitionfill', 3)
        self.assert_json_equal('', 'partitionfill/@0/owner', 'Minimum')
        self.assert_json_equal('', 'partitionfill/@0/ratio', 45.0)
        self.assert_json_equal('', 'partitionfill/@0/ventilated', 33.75)
        self.assert_json_equal('', 'partitionfill/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partitionfill/@1/ratio', 35.0)
        self.assert_json_equal('', 'partitionfill/@1/ventilated', 26.25)
        self.assert_json_equal('', 'partitionfill/@2/owner', 'Dalton Joe')
        self.assert_json_equal('', 'partitionfill/@2/ratio', 20.0)
        self.assert_json_equal('', 'partitionfill/@2/ventilated', 15.0)
    ...
    def test_ventilation_credit(self):
        ...
        self.assert_json_equal('', 'callfunds/@0/num', '2')
        self.assert_json_equal('', 'callfunds/@0/date', '2015-07-14')
        self.assert_json_equal('', 'callfunds/@0/total', 45.00)
        self.assert_json_equal('', 'callfunds/@0/supporting.total_rest_topay', 15.00)
        self.assert_json_equal('', 'callfunds/@1/num', '1')
        self.assert_json_equal('', 'callfunds/@1/date', '2015-06-10')
        self.assert_json_equal('', 'callfunds/@1/total', 131.25)
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 31.25)
        ...
        self.assert_json_equal('', 'callfunds/@0/date', '2015-07-14')
        self.assert_json_equal('', 'callfunds/@0/total', 45.00)
        self.assert_json_equal('', 'callfunds/@0/supporting.total_rest_topay', 17.07)
        self.assert_json_equal('', 'callfunds/@1/num', '1')
        self.assert_json_equal('', 'callfunds/@1/date', '2015-06-10')
        self.assert_json_equal('', 'callfunds/@1/total', 131.25)
        ...
        self.factory.xfer = PaymentMultiPay()
        self.calljson('/diacamma.condominium/paymentMultiPay', {'owner': 1}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'paymentMultiPay')
        ...
        self.assertEqual(self.response_json['action']['params']['supportings'], '1;8')
        ...
        self.calljson('/diacamma.payoff/payoffAddModify', {'supportings': '1;8', 'NO_REPARTITION': 'yes', 'repartition': '1'}, False)
    ...
    def test_ventilation_debit(self):
        ...
        self.assert_json_equal('', 'callfunds/@0/num', '2')
        self.assert_json_equal('', 'callfunds/@0/date', '2015-07-14')
        self.assert_json_equal('', 'callfunds/@0/total', 35.00)
        self.assert_json_equal('', 'callfunds/@0/supporting.total_rest_topay', 35.00)
        self.assert_json_equal('', 'callfunds/@1/num', '1')
        self.assert_json_equal('', 'callfunds/@1/date', '2015-06-10')
        ...
        self.factory.xfer = PaymentVentilatePay()
        self.calljson('/diacamma.condominium/paymentVentilatePay', {'CONFIRME': 'YES', 'owner': 2}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'paymentVentilatePay')
        ...
        self.assert_json_equal('', 'callfunds/@1/total', 87.50)
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 0.00)
        self.assert_json_equal('', 'callfunds/@2/num', None)
        self.assert_json_equal('', 'callfunds/@2/date', '2015-01-01')
        self.assert_json_equal('', 'callfunds/@2/total', 12.50)
        ...
        self.factory.xfer = PaymentMultiPay()
        self.calljson('/diacamma.condominium/paymentMultiPay', {'owner': 2}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'paymentMultiPay')
        self.assertEqual(self.response_json['action']['id'], "diacamma.payoff/payoffAddModify")
        self.assertEqual(len(self.response_json['action']['params']), 3)
...
-3|18|7|70.000000|0|0|None|""", True)
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'ownerShow')
        self.assert_json_equal('LABELFORM', 'third', 'Minimum')
        self.assert_count_equal('payments', 1)
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'ownerShow')
        self.assert_json_equal('LABELFORM', 'third', 'Dalton William')
        self.assert_count_equal('payments', 0)
        ...
        self.assert_json_equal('', 'callfunds/@1/num', None)
        self.assert_json_equal('', 'callfunds/@1/total', 12.5)
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 12.5)
        self.assert_count_equal('payoff', 0)
        ...
        self.assert_count_equal('callfunds', 2)
        self.assert_json_equal('', 'callfunds/@0/num', '1')
        self.assert_json_equal('', 'callfunds/@0/total', 56.25)
        self.assert_json_equal('', 'callfunds/@0/supporting.total_rest_topay', 0.0)
        self.assert_json_equal('', 'callfunds/@1/num', None)
        self.assert_json_equal('', 'callfunds/@1/total', 70.0)
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 70.0)
        self.assert_count_equal('payoff', 1)
    ...
    def test_ventilation_internal_payoff(self):
        ...
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 0.00)
        self.assert_count_equal('payoff', 0)
        self.assert_count_equal('payments', 3)
        self.assert_count_equal('#payments/actions', 3)
        self.assert_json_equal('', '#payments/actions/@0/action', 'paymentMultiPay')
        self.assert_json_equal('', '#payments/actions/@1/action', 'paymentVentilatePay')
        self.assert_json_equal('', '#payments/actions/@2/action', 'paymentDel')
        ...
        self.factory.xfer = PayoffAddModify()
        self.calljson('/diacamma.payoff/payoffAddModify', {'SAVE': 'YES', 'supporting': 12, 'amount': '75.0',
                                                           'date': '2015-08-28', 'mode': 6, 'linked_supporting': 1}, False)
        self.assert_observer('core.acknowledge', 'diacamma.payoff', 'payoffAddModify')

        self.factory.xfer = PayoffAddModify()
        self.calljson('/diacamma.payoff/payoffAddModify', {'SAVE': 'YES', 'supporting': 11, 'amount': '10.0',
        ...
        self.assert_json_equal('LABELFORM', 'total_all_call', 176.25)
        self.assert_json_equal('LABELFORM', 'total_payoff', 215.0)
        ...
        self.assert_json_equal('LABELFORM', 'sumtopay', 0.0)
        self.assert_count_equal('callfunds', 2)
        self.assert_json_equal('', 'callfunds/@0/supporting.total_rest_topay', 7.07)
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 0.00)
        self.assert_count_equal('payoff', 1)
        self.assert_json_equal('', 'payoff/@0/date', "2015-08-28")
        self.assert_json_equal('', 'payoff/@0/mode', 6)
...
-3|18|7|70.000000|0|0|None|""", True)
        ...
        self.assert_json_equal('', 'payoff/@0/amount', 70.0)
        self.assert_count_equal('payments', 1)
        self.assert_count_equal('#payments/actions', 4)
        self.assert_json_equal('', '#payments/actions/@0/action', 'paymentMultiPay')
        self.assert_json_equal('', '#payments/actions/@1/action', 'paymentRefund')
        self.assert_json_equal('', '#payments/actions/@2/action', 'paymentVentilatePay')
        self.assert_json_equal('', '#payments/actions/@3/action', 'paymentDel')

        self.factory.xfer = PaymentRefund()
        self.calljson('/diacamma.condominium/paymentRefund', {'owner': 3}, False)
        self.assert_observer('core.custom', 'diacamma.condominium', 'paymentRefund')
        self.assert_count_equal('', 6)
        self.assert_json_equal('LABELFORM', 'supportings', 'Dalton Joe')
        self.assert_json_equal('FLOAT', 'amount', 70.0)

        self.factory.xfer = PaymentRefund()
        self.calljson('/diacamma.condominium/paymentRefund', {'SAVE': 'YES', 'owner': 3, 'amount': 50.0, 'mode': 0, 'reference': 'abc123',
                                                              'bank_account': 0, 'date': '2015-02-03', 'fee_bank': 0.0}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'paymentRefund')
        ...
        self.assert_count_equal('payments', 2)
        self.assert_count_equal('#payments/actions', 4)
        self.assert_json_equal('', '#payments/actions/@0/action', 'paymentMultiPay')
        self.assert_json_equal('', '#payments/actions/@1/action', 'paymentRefund')
        self.assert_json_equal('', '#payments/actions/@2/action', 'paymentVentilatePay')
...
-3|18|7|70.000000|0|0|None|""", True)
        ...
        self.assert_json_equal('', 'callfunds/@0/num', '1')
        self.assert_json_equal('', 'callfunds/@0/total', 56.25)
        self.assert_json_equal('', 'callfunds/@0/supporting.total_rest_topay', 56.25)
        self.assert_json_equal('', 'callfunds/@1/num', None)
        self.assert_json_equal('', 'callfunds/@1/total', 70.0)
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 70.0)
        self.assert_count_equal('payoff', 1)
...
-3|18|7|70.000000|0|0|None|""", True)
        ...
        self.factory.xfer = PaymentRefund()
        self.calljson('/diacamma.condominium/paymentRefund', {'SAVE': 'YES', 'owner': 3, 'amount': 70.0, 'mode': 0, 'reference': 'abc123',
                                                              'bank_account': 0, 'date': '2015-02-03', 'fee_bank': 0.0}, False)
        self.assert_observer('core.acknowledge', 'diacamma.condominium', 'paymentRefund')
...
-3|2|0|1880.000000|0|0|None|""", True)
    ...
    def _config_comdominum(self):
        ...
        new_set = Set.objects.create(name="Escalier", is_link_to_lots=True, secondarykey=subkey1, type_load=0)
        new_set.set_of_lots.set(PropertyLot.objects.all())
        new_set.save()
        _set_budget(new_set, '601', 120.0)

        new_set = Set.objects.create(name="Chauffage", is_link_to_lots=True, secondarykey=subkey2, type_load=0)
        new_set.set_of_lots.set(PropertyLot.objects.all())
        new_set.save()
        _set_budget(new_set, '601', 2030.0)

        new_set = Set.objects.create(name="Sous-sol", is_link_to_lots=True, secondarykey=subkey3, type_load=0)
        new_set.set_of_lots.set(PropertyLot.objects.all())
        new_set.save()
    ...
    def test_add_first_current_calloffunds(self):
        ...
        self.assert_json_equal('', 'callfunds/@0/date', "2016-10-01")
        self.assert_json_equal('', 'callfunds/@1/date', "2016-07-01")
        self.assert_json_equal('', 'callfunds/@2/date', "2016-04-01")
        self.assert_json_equal('', 'callfunds/@3/date', "2016-01-01")
