...
class OwnerTest(PaymentTest):
    ...
    def test_close_classload(self):
        ...
        self.assert_json_equal('LABELFORM', 'result', '{[b]}Produit :{[/b]} 350.00€ - {[b]}Charge :{[/b]} 187.34€ = {[b]}Résultat :{[/b]} 162.66€{[br/]}{[b]}Trésorerie :{[/b]} 24.34€ - {[b]}Validé :{[/b]} 4.34€')
        ...
        self.assert_json_equal('LABELFORM', 'result', '{[b]}Produit :{[/b]} 350.00€ - {[b]}Charge :{[/b]} 187.34€ = {[b]}Résultat :{[/b]} 162.66€{[br/]}{[b]}Trésorerie :{[/b]} 24.34€ - {[b]}Validé :{[/b]} 24.34€')
...
class OwnerBelgiumTest(PaymentTest):
    ...
    def test_owner_situation(self):
        ...
        self.assert_grid_equal('partition', {"set": "catégorie de charges", 'set.budget_txt': 'budget', 'set.sumexpense_txt': 'dépense',
                                             'value': 'tantième', 'ratio': 'ratio', "ventilated_txt": "ventilé", 'recovery_load_txt': 'charges récupérables'}, 2)
        self.assert_json_equal('', 'partition/@1/set', "[2] BBB")
        self.assert_json_equal('', 'partition/@1/set.budget_txt', "120.00€")
        self.assert_json_equal('', 'partition/@1/set.sumexpense_txt', '100.00€')
        self.assert_json_equal('', 'partition/@1/value', "75.00")
        self.assert_json_equal('', 'partition/@1/ratio', "75.0 %")
        self.assert_json_equal('', 'partition/@1/ventilated_txt', "75.00€")
        self.assert_json_equal('', 'partition/@1/recovery_load_txt', "30.00€")
        self.assert_json_equal('LABELFORM', 'total_current_call', "131.25€")
        self.assert_json_equal('LABELFORM', 'total_current_payoff', "100.00€")
        self.assert_json_equal('LABELFORM', 'total_current_ventilated', "75.00€")
        self.assert_json_equal('LABELFORM', 'total_recoverable_load', "30.00€")
    ...
    def test_owner_load_count(self):
        ...
        self.assert_json_equal('', 'loadcount/@0/total', "{[i]}100.00€{[/i]}")
        self.assert_json_equal('', 'loadcount/@0/ratio', "{[i]}75/100{[/i]}")
        self.assert_json_equal('', 'loadcount/@0/ventilated', "{[i]}75.00€{[/i]}")
        self.assert_json_equal('', 'loadcount/@0/recoverable_load', "{[i]}30.00€{[/i]}")
        self.assert_json_equal('', 'loadcount/@1/designation', "&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;{[b]}[602000] 602000{[/b]}")
        self.assert_json_equal('', 'loadcount/@1/total', "{[b]}100.00€{[/b]}")
        self.assert_json_equal('', 'loadcount/@1/ratio', "{[b]}75/100{[/b]}")
        self.assert_json_equal('', 'loadcount/@1/ventilated', "{[b]}75.00€{[/b]}")
        self.assert_json_equal('', 'loadcount/@1/recoverable_load', "{[b]}30.00€{[/b]}")

        self.assert_json_equal('', 'loadcount/@4/designation', "{[i]}[3] CCC{[/i]}")
        self.assert_json_equal('', 'loadcount/@4/total', "{[i]}75.00€{[/i]}")
        self.assert_json_equal('', 'loadcount/@4/ratio', "{[i]}45/100{[/i]}")
        self.assert_json_equal('', 'loadcount/@4/ventilated', "{[i]}33.75€{[/i]}")
        self.assert_json_equal('', 'loadcount/@4/recoverable_load', "{[i]}20.25€{[/i]}")
        self.assert_json_equal('', 'loadcount/@5/designation', "&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;{[b]}[601000] 601000{[/b]}")
        self.assert_json_equal('', 'loadcount/@5/total', "{[b]}75.00€{[/b]}")
        self.assert_json_equal('', 'loadcount/@5/ratio', "{[b]}45/100{[/b]}")
        self.assert_json_equal('', 'loadcount/@5/ventilated', "{[b]}33.75€{[/b]}")
        self.assert_json_equal('', 'loadcount/@5/recoverable_load', "{[b]}20.25€{[/b]}")

        self.assert_json_equal('', 'loadcount/@8/designation', "")
        self.assert_json_equal('', 'loadcount/@8/total', "{[u]}175.00€{[/u]}")
        self.assert_json_equal('', 'loadcount/@8/ratio', "")
        self.assert_json_equal('', 'loadcount/@8/ventilated', "{[u]}108.75€{[/u]}")
        self.assert_json_equal('', 'loadcount/@8/recoverable_load', "{[u]}50.25€{[/u]}")
...
class OwnerTestOldAccounting(PaymentTest):
    ...
    def test_close_classload(self):
        ...
        self.assert_observer('core.custom', 'diacamma.accounting', 'entryAccountList')
        self.assert_count_equal('entryline', 2)
        self.assert_json_equal('LABELFORM', 'result', '{[b]}Produit :{[/b]} 175.00€ - {[b]}Charge :{[/b]} 187.34€ = {[b]}Résultat :{[/b]} -12.34€{[br/]}{[b]}Trésorerie :{[/b]} 31.11€ - {[b]}Validé :{[/b]} 11.11€')
        ...
        self.assert_observer('core.custom', 'diacamma.accounting', 'entryAccountList')
        self.assert_count_equal('entryline', 2)
        self.assert_json_equal('LABELFORM', 'result', '{[b]}Produit :{[/b]} 175.00€ - {[b]}Charge :{[/b]} 187.34€ = {[b]}Résultat :{[/b]} -12.34€{[br/]}{[b]}Trésorerie :{[/b]} 31.11€ - {[b]}Validé :{[/b]} 31.11€')
