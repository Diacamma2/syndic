...
class SetOwnerTest(LucteriosTest):
    ...
    def test_add_set(self):
        ...
        self.assert_json_equal('', 'set/@0/partition_set', '')
        ...
        self.assert_json_equal('', 'set/@1/partition_set', '')
    ...
    def test_add_owner(self):
        ...
        self.assert_json_equal('', 'owner/@0/total_current_initial', '0.00€')
        self.assert_json_equal('', 'owner/@0/total_current_call', '0.00€')
        self.assert_json_equal('', 'owner/@0/total_current_payoff', '0.00€')
        self.assert_json_equal('', 'owner/@0/total_current_ventilated', '0.00€')
        self.assert_json_equal('', 'owner/@0/total_current_owner', '0.00€')
        self.assert_json_equal('', 'owner/@0/total_current_regularization', '0.00€')
    ...
    def test_show_partition(self):
        ...
        self.assert_json_equal('', 'set/@0/partition_set', "Minimum : 0.0 %{[br/]}Dalton William : 0.0 %{[br/]}Dalton Joe : 0.0 %")
        self.assert_json_equal('', 'set/@0/sumexpense_txt', "0.00€")
        self.assert_json_equal('', 'set/@1/identify', '[2] BBB')
        self.assert_json_equal('', 'set/@1/budget_txt', '0.00€')
        self.assert_json_equal('', 'set/@1/type_load', 'charge courante')
        self.assert_json_equal('', 'set/@1/partition_set', "Minimum : 0.0 %{[br/]}Dalton William : 0.0 %{[br/]}Dalton Joe : 0.0 %")
        self.assert_json_equal('', 'set/@1/sumexpense_txt', "0.00€")
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'setList')
        self.assert_count_equal('set', 2)
        self.assert_json_equal('', 'set/@0/partition_set', "Minimum : 0.0 %{[br/]}Dalton William : 0.0 %")
        self.assert_json_equal('', 'set/@1/partition_set', "Minimum : 0.0 %{[br/]}Dalton William : 0.0 %")
    ...
    def test_modify_partition(self):
        ...
        self.assert_json_equal('', 'partition/@0/ratio', '0.0 %')
        self.assert_json_equal('', 'partition/@0/ventilated_txt', '0.00€')
        self.assert_json_equal('', 'partition/@1/value', '0.00')
        self.assert_json_equal('', 'partition/@1/ratio', '0.0 %')
        self.assert_json_equal('', 'partition/@1/ventilated_txt', '0.00€')
        self.assert_json_equal('', 'partition/@2/value', '0.00')
        self.assert_json_equal('', 'partition/@2/ratio', '0.0 %')
        self.assert_json_equal('', 'partition/@1/ventilated_txt', '0.00€')
        ...
        self.assert_json_equal('', 'set/@0/partition_set', "Minimum : 16.7 %{[br/]}Dalton William : 33.3 %{[br/]}Dalton Joe : 50.0 %")
