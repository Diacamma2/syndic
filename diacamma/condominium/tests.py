...
class OwnerTest(PaymentTest):
    ...
    def test_set_ventilation(self):
        ...
        self.assert_json_equal('LABELFORM', 'is_link_to_lots', False)
        self.assert_json_equal('', 'partition/@0/owner', 'Minimum')
        self.assert_json_equal('', 'partition/@0/ratio', 75.0)
        self.assert_json_equal('', 'partition/@0/ventilated', 75.0)
        self.assert_json_equal('', 'partition/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partition/@1/ratio', 0.0)
        self.assert_json_equal('', 'partition/@1/ventilated', 0.0)
        self.assert_json_equal('', 'partition/@2/owner', 'Dalton Joe')
        self.assert_json_equal('', 'partition/@2/ratio', 25.0)
        self.assert_json_equal('', 'partition/@2/ventilated', 25.0)
