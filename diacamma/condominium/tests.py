...
from diacamma.condominium.views import SetOwnerList, SetAddModify, SetDel,\
    OwnerAddModify, OwnerDel, SetShow, PartitionAddModify
...
class SetOwnerTest(LucteriosTest):
    ...
    def test_add_owner(self):
        ...
        self.assert_count_equal('COMPONENTS/GRID[@name="owner"]/HEADER', 6)

        self.factory.xfer = OwnerAddModify()
    ...
    def test_modify_partition(self):
        ...
        self.assert_count_equal('COMPONENTS/GRID[@name="partition"]/HEADER', 3)
        self.assert_count_equal(
