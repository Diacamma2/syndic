...
class OwnerTest(PaymentTest):
    ...
    def test_set_ventilation(self):
        ...
        self.assert_json_equal('', 'partition/@0/owner', 'Minimum')
        self.assert_json_equal('', 'partition/@0/ratio', 45.0)
        self.assert_json_equal('', 'partition/@0/ventilated', 33.75)
        self.assert_json_equal('', 'partition/@1/owner', 'Dalton William')
        self.assert_json_equal('', 'partition/@1/ratio', 35.0)
        self.assert_json_equal('', 'partition/@1/ventilated', 26.25)
        self.assert_json_equal('', 'partition/@2/owner', 'Dalton Joe')
        self.assert_json_equal('', 'partition/@2/ratio', 20.0)
        self.assert_json_equal('', 'partition/@2/ventilated', 15.0)
