...
class SetOwnerTest(LucteriosTest):
    ...
    def test_modify_partition(self):
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'setShow')
        self.assert_count_equal('', 10)
        self.assert_grid_equal('partitionfill', {"owner": "propriétaire", "value": "tantième", "ratio": "ratio", "ventilated_txt": "ventilé"}, 0)  # nb=4
        self.assert_count_equal('#partitionfill/actions', 1)
        ...
        self.assert_json_equal('', 'partitionfill/@0/ratio', '16.7 %')
        self.assert_json_equal('', 'partitionfill/@1/value', '20.00')
        self.assert_json_equal('', 'partitionfill/@1/ratio', '33.3 %')
