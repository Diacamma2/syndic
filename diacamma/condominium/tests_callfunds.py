...
class CallFundsTest(LucteriosTest):
    ...
    def test_add_default_current(self):
        ...
        self.assert_json_equal('', 'callfunds/@0/date', "2015-10-01")
        self.assert_json_equal('', 'callfunds/@1/date', "2015-07-01")
        self.assert_json_equal('', 'callfunds/@2/date', "2015-04-01")
        self.assert_json_equal('', 'callfunds/@3/date', "2015-01-01")
    ...
    def test_add_default_current_monthly(self):
        ...
        self.assert_json_equal('', 'callfunds/@0/date', "2015-12-01")
        self.assert_json_equal('', 'callfunds/@1/date', "2015-11-01")
        self.assert_json_equal('', 'callfunds/@2/date', "2015-10-01")
        self.assert_json_equal('', 'callfunds/@3/date', "2015-09-01")
        self.assert_json_equal('', 'callfunds/@4/date', "2015-08-01")
        self.assert_json_equal('', 'callfunds/@5/date', "2015-07-01")
        self.assert_json_equal('', 'callfunds/@6/date', "2015-06-01")
        self.assert_json_equal('', 'callfunds/@7/date', "2015-05-01")
        self.assert_json_equal('', 'callfunds/@8/date', "2015-04-01")
        self.assert_json_equal('', 'callfunds/@9/date', "2015-03-01")
        self.assert_json_equal('', 'callfunds/@10/date', "2015-02-01")
        self.assert_json_equal('', 'callfunds/@11/date', "2015-01-01")
    ...
    def test_delete(self):
        ...
        self.assert_json_equal('', 'callfunds/@0/id', 6)
        self.assert_json_equal('', 'callfunds/@0/num', 2)
        self.assert_json_equal('', 'callfunds/@0/owner', "Minimum")
        self.assert_json_equal('', 'callfunds/@0/total', 45.0)
        self.assert_json_equal('', 'callfunds/@0/supporting.total_rest_topay', 15.0)
        self.assert_json_equal('', 'callfunds/@1/id', 7)
        self.assert_json_equal('', 'callfunds/@2/num', 2)
        self.assert_json_equal('', 'callfunds/@1/owner', "Dalton William")
        self.assert_json_equal('', 'callfunds/@1/total', 35.0)
        self.assert_json_equal('', 'callfunds/@1/supporting.total_rest_topay', 35.0)
        self.assert_json_equal('', 'callfunds/@2/id', 8)
        self.assert_json_equal('', 'callfunds/@2/num', 2)
        self.assert_json_equal('', 'callfunds/@2/owner', "Dalton Joe")
        self.assert_json_equal('', 'callfunds/@2/total', 20.0)
        self.assert_json_equal('', 'callfunds/@2/supporting.total_rest_topay', 6.25)
        self.assert_json_equal('', 'callfunds/@3/id', 2)
        self.assert_json_equal('', 'callfunds/@3/num', 1)
        self.assert_json_equal('', 'callfunds/@3/owner', "Minimum")
        self.assert_json_equal('', 'callfunds/@3/total', 131.25)
        self.assert_json_equal('', 'callfunds/@3/supporting.total_rest_topay', 31.25)
        self.assert_json_equal('', 'callfunds/@4/id', 3)
        self.assert_json_equal('', 'callfunds/@4/num', 1)
        self.assert_json_equal('', 'callfunds/@4/owner', "Dalton William")
        self.assert_json_equal('', 'callfunds/@4/total', 87.5)
        self.assert_json_equal('', 'callfunds/@4/supporting.total_rest_topay', 87.5)
        self.assert_json_equal('', 'callfunds/@5/id', 4)
        self.assert_json_equal('', 'callfunds/@5/num', 1)
        self.assert_json_equal('', 'callfunds/@5/owner', "Dalton Joe")
        self.assert_json_equal('', 'callfunds/@5/total', 56.25)
        self.assert_json_equal('', 'callfunds/@5/supporting.total_rest_topay', 0.0)
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'callFundsList')
        self.assert_count_equal('callfunds', 2)
        self.assert_json_equal('', 'callfunds/@0/total', 100.0)
        self.assert_json_equal('', 'callfunds/@1/total', 275.0)
...
class CallFundsBelgiumTest(LucteriosTest):
    ...
    def test_add_default_current(self):
        ...
        self.assert_observer('core.custom', 'diacamma.condominium', 'callFundsList')
        self.assert_count_equal('callfunds', 2)
        self.assert_json_equal('', 'callfunds/@0/date', "2015-02-01")
        self.assert_json_equal('', 'callfunds/@0/total', 110.00)
        self.assert_json_equal('', 'callfunds/@1/date', "2015-01-01")
        ...
        self.assert_count_equal('callfunds', 12)
        self.assert_json_equal('', 'callfunds/@0/date', "2015-12-01")
        self.assert_json_equal('', 'callfunds/@0/total', 230.00)
        self.assert_json_equal('', 'callfunds/@1/date', "2015-11-01")
        self.assert_json_equal('', 'callfunds/@1/total', 230.00)
        self.assert_json_equal('', 'callfunds/@2/date', "2015-10-01")
        ...
        self.assert_json_equal('', 'callfunds/@10/date', "2015-02-01")
        self.assert_json_equal('', 'callfunds/@10/total', 110.0)
        self.assert_json_equal('', 'callfunds/@11/date', "2015-01-01")
        self.assert_json_equal('', 'callfunds/@11/total', 110.0)
        self.assertEqual(len(self.json_actions), 1)
